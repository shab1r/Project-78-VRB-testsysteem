...
class RemoteProg():
    ...
    def Remote():
        ...
        print("Vici valve switch finished!!!")
        ...
        print("On launch started!!!")
                #Set up plot
        figure, ax = plt.subplots(num="Chromatogram 1")
        lines, = ax.plot([],[])
        ...
        ax.set_ylim(min2_y, max2_y)
                #Other stuff
        ax.grid()
        ...
            
        
        print("On launch finished")
